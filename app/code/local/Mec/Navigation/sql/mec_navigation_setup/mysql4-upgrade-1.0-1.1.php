...
$installer->getConnection()->addColumn($this->getTable('mec_navigation_attribute'), 'filter_reset',
    "TINYINT(1) NOT NULL DEFAULT 0");
...
$installer->getConnection()->addColumn($this->getTable('mec_navigation_attribute'), 'is_ajax',
    "TINYINT(1) NOT NULL DEFAULT 0");
