...
$attribute_data = array(
        ...
        'input'             => 'select',
        'class'             => '',
        'source'            => 'mec_navigation/adminhtml_system_config_source_category_template',
        'global'            => true,
        'visible'           => true,
        'required'          => false,
        'user_defined'      => false,
...
$attribute_data = array(
        ...
        'input'             => 'text',
        'class'             => '',
		'frontend_class'    => 'mec-validate-number',
        'source'            => '',
        'global'            => true,
        'visible'           => true,
        'required'          => false,
...
$attribute_data = array(
        ...
        'input'             => 'select',
        'class'             => '',
        'source'            => 'mec_navigation/adminhtml_system_config_source_category_column',
        'global'            => true,
        'visible'           => true,
        'required'          => false,
        'user_defined'      => false,
...
$attribute_data = array(
        ...
        'input'             => 'select',
        'class'             => '',
        'source'            => 'mec_navigation/adminhtml_system_config_source_category_attribute_view',
        'global'            => true,
        'visible'           => true,
        'required'          => false,
        'user_defined'      => false,
...
$attribute_data = array(
        ...
        'input'             => 'select',
        'class'             => '',
        'source'            => 'mec_navigation/adminhtml_system_config_source_category_image_position',
        'global'            => true,
        'visible'           => true,
        'required'          => false,
        'user_defined'      => false,
...
$installer->run("
ALTER TABLE `{$this->getTable('mec_navigation_attribute')}`
...
$installer->run("
CREATE TABLE IF NOT EXISTS `{$this->getTable('mec_navigation_attribute_store')}` (
  `id` smallint(6) NOT NULL auto_increment,	
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) NOT NULL default '0',
  `popup_text` TEXT,
  PRIMARY KEY  (`id`),
  CONSTRAINT `FK_mec_navigation_attribute_store` FOREIGN KEY (`attribute_id`) REFERENCES `{$this->getTable('eav_attribute')}` (`attribute_id`) ON DELETE CASCADE
