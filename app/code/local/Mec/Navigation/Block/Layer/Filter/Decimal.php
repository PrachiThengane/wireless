...
class Mec_Navigation_Block_Layer_Filter_Decimal extends Mage_Catalog_Block_Layer_Filter_Decimal
{
    	...
    	if(Mage::helper('mec_navigation')->isMecNavigation()){
        	...
        	switch($this->getAttributeModel()->getFilterType()): 
	        	...
	        	default:
	        		...
	        		$this->_template = ('mec/navigation/layer/filter/default.phtml');
	        	
	        	break;
	        	
	        	case(Mec_Navigation_Model_Layer::FILTER_TYPE_INPUT):
	        	
	        		$this->_template = ('mec/navigation/layer/filter/input.phtml');
	        	
	        	break;
	        	
	        	case(Mec_Navigation_Model_Layer::FILTER_TYPE_SLIDER):
	        	
	        		$this->_template = ('mec/navigation/layer/filter/slider.phtml');
	        	
	        	break;
	        	
	        	case(Mec_Navigation_Model_Layer::FILTER_TYPE_SLIDER_INPUT):
	        	
	        		$this->_template = ('mec/navigation/layer/filter/slider-input.phtml');
	        	
	        	break;
	        	
	        	case(Mec_Navigation_Model_Layer::FILTER_TYPE_INPUT_SLIDER):
	        	
	        		$this->_template = ('mec/navigation/layer/filter/input-slider.phtml');
