...
class Mec_Navigation_Block_Adminhtml_Config_Form_Renderer_Navigationtype extends Mage_Adminhtml_Block_System_Config_Form_Field
{
        ...
        $javaScript = "
            <script type=\"text/javascript\">
                ...
                function init_{$element->getHtmlId()}() {
                	Mec_Navigation_fireEvent($('{$element->getHtmlId()}'), 'change');
                }
            </script>";
