...
class Mec_Navigation_Block_Adminhtml_Catalog_Category_Tab_Attributes extends Mage_Adminhtml_Block_Catalog_Category_Tab_Attributes
{
    	...
    	if ($group->getAttributeGroupName() == 'Advanced Navigation'){
	        ...
	        if (count($attributes_pw_s)){
	        	$fieldset = $form->addFieldset('fieldset_group_' . $group->getId() . '_pw_s', array(
		            'legend'    => Mage::helper('mec_navigation')->__('Plain Window Settings'),
		            'class'     => 'fieldset-wide',
		        ));
    		...
    		if (count($attributes_pw_m)){
	        	$fieldset = $form->addFieldset('fieldset_group_' . $group->getId() . '_pw_m', array(
		            'legend'    => Mage::helper('mec_navigation')->__('Menu Bar Settings'),
		            'class'     => 'fieldset-wide',
		        ));
    		...
    		if (count($attributes_pw_fl)){
	        	$fieldset = $form->addFieldset('fieldset_group_' . $group->getId() . '_pw_fl', array(
		            'legend'    => Mage::helper('mec_navigation')->__('First Level Subcategory Settings'),
		            'class'     => 'fieldset-wide',
		        ));
    		...
    		if (count($attributes_pw_sl)){
	        	$fieldset = $form->addFieldset('fieldset_group_' . $group->getId() . '_pw_sl', array(
		            'legend'    => Mage::helper('mec_navigation')->__('Second Level Subcategory Settings'),
		            'class'     => 'fieldset-wide',
		        ));
    		...
    		if (count($attributes_pw_ob)){
	        	$fieldset = $form->addFieldset('fieldset_group_' . $group->getId() . '_pw_ob', array(
		            'legend'    => Mage::helper('mec_navigation')->__('Offer Block Settings'),
		            'class'     => 'fieldset-wide',
		        ));
	        ...
	        $fieldset = $form->addFieldset('fieldset_group_' . $group->getId() . '_lr', array(
	            'legend'    => Mage::helper('mec_navigation')->__('Left / Right Column Navigation'),
	            'class'     => 'fieldset-wide',
	        ));
