...
class Mec_Navigation_Block_Navigation extends Mage_Core_Block_Template
{
        ...
        switch ($this->_navigation_place)
        {
            case self::MENU_BAR :
                  if(Mage::helper('mec_navigation')->isMecNavigation())  
                      $this->_type_navigation = Mage::getStoreConfig('mec_navigation/menubarsettings/navigation');
                  else
                      $this->_type_navigation = Mec_Navigation_Model_Layer::FILTER_TYPE_DEFAULT;    
                break;
            case self::LEFT_COLUMN :
                  $this->_type_navigation = Mage::getStoreConfig('mec_navigation/category/filter_type');
                break;    
            case self::RIGTH_COLUMN :
                  $this->_type_navigation = Mage::getStoreConfig('mec_navigation/rightcolumnsettings/filter_type');
                break;        
    ...
    {
        if ($this->getTypeNavigation() == Mec_Navigation_Model_Layer::FILTER_TYPE_DEFAULT_PRO)
            return false;
        ...
        switch ($this->_navigation_place)
        {
            case self::MENU_BAR :
                ...
                break;
            case self::LEFT_COLUMN :                                    
                     return (Mage::getStoreConfig('mec_navigation/category/ajax_enabled') == 1) &&
                ...
                break;    
            case self::RIGTH_COLUMN :                  
                     return (Mage::getStoreConfig('mec_navigation/rightcolumnsettings/ajax_enabled') == 1) &&
                      		 ((Mage::app()->getFrontController()->getRequest()->getRouteName() == 'catalogsearch' &&
                 			   Mage::app()->getFrontController()->getRequest()->getControllerName() != 'advanced') ||	
                               (Mage::registry('current_category') && 
                                Mage::registry('current_category')->getisAnchor() &&
    ...
    {        
        ...
        return urlencode(Mage::helper('mec_navigation')->getFilterUrl('*/*/*', $params));
    }
    ...
    public function canShowMinimized(){
        ...
        switch ($this->_navigation_place)
        {
            ...
            case self::RIGTH_COLUMN :
        		  ...
        		  return (bool) Mage::getStoreConfigFlag('mec_navigation/rightcolumnsettings/show_minimized');
                break;                        
        } 
	}
    ...
    public function canShowPopup(){
        ...
        switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return (bool) Mage::getStoreConfigFlag('mec_navigation/rightcolumnsettings/show_help');
                break;                        
        }		
    ...
    public function getPopupText(){
        ...
        switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return trim(Mage::getStoreConfig('mec_navigation/rightcolumnsettings/popup_text'));
                break;                        
        }				
	}
    ...
    public function getPopupWidth(){
        ...
        switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return (int) Mage::getStoreConfig('mec_navigation/rightcolumnsettings/popup_width');
                break;                        
        }				
	}
	...
	public function getPopupHeight(){
	    ...
	    switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return (int) Mage::getStoreConfig('mec_navigation/rightcolumnsettings/popup_height');
                break;                        
        }				
	}
    ...
    public function canShowLabels(){
        ...
        switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return (bool) Mage::getStoreConfigFlag('mec_navigation/rightcolumnsettings/show_image_name');
                break;                        
        }
    ...
    public function getImageWidth(){
        ...
        switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return (int) Mage::getStoreConfig('mec_navigation/rightcolumnsettings/image_width');
                break;                        
        }        		
	}
	...
	public function getImageHeight(){
	    ...
	    switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return (int) Mage::getStoreConfig('mec_navigation/rightcolumnsettings/image_height');
                break;                        
        }
	...
	public function getImageAlign(){
	    ...
	    switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    switch(Mage::getStoreConfig('mec_navigation/rightcolumnsettings/image_align'))
                    {		
            			default:            				
            				$image_align = 'default';            				
            			break;            			
    ...
    public function canShowCheckbox(){
        ...
        switch ($this->_navigation_place)
        {
            ...
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return (bool) Mage::getStoreConfigFlag('mec_navigation/rightcolumnsettings/show_checkbox');
                break;                        
        }
    ...
    public function getInBlockHeight(){
        ...
        switch ($this->_navigation_place)
        {
            case self::LEFT_COLUMN :
                ...
                break;    
            case self::RIGTH_COLUMN :
                    return Mage::getStoreConfig('mec_navigation/rightcolumnsettings/inblock_height');
                break;                        
        }
    ...
    public function getColumnColor(){
        ...
        {            
            case self::LEFT_COLUMN :
                    return Mage::helper('mec_navigation')->formatColor(Mage::getStoreConfig('mec_navigation/category/column_color'));    
                break;    
            case self::RIGTH_COLUMN :
                    return Mage::helper('mec_navigation')->formatColor(Mage::getStoreConfig('mec_navigation/rightcolumnsettings/column_color'));                     
                break;                        
        }
	...
	public function getIsShowAllSubcategories(){
	    switch ($this->_navigation_place)
        {
            case self::MENU_BAR :
                ...
                break;
            case self::LEFT_COLUMN :
                    return Mage::getStoreConfigFlag('mec_navigation/category/show_allsubcats');    
                break;    
            case self::RIGTH_COLUMN :
                    return Mage::getStoreConfigFlag('mec_navigation/rightcolumnsettings/show_allsubcats');                     
                break;                        
        }
	}
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        if ($isFirst && $this->getTypeNavigation() == Mec_Navigation_Model_Layer::FILTER_TYPE_ACCORDION){
        ...
        switch ($this->getTypeNavigation())
        {
            case Mec_Navigation_Model_Layer::FILTER_TYPE_DROPDOWN:
                ...
                break;
            case Mec_Navigation_Model_Layer::FILTER_TYPE_PLAIN: 
	                ...
	                if ($this->_navigation_place == self::MENU_BAR){
					   if ($category->getData('navigation_pw_ob_show')){
					   		...
					   		if ($category->getData('navigation_pw_ob_bgcolor')){
					   			$offer_block_styles .= 'background-color:' . Mage::helper('mec_navigation')->formatColor($category->getData('navigation_pw_ob_bgcolor')) . ';';
					   		}
					   		...
					   		$offer_block_class = Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::getOfferBlockPositionClass($category->getData('navigation_pw_ob_pos'));
                    ...
                    { 
                       ...
                       if ($this->_navigation_place == self::MENU_BAR){
                       		if ($category->getData('navigation_pw_s_bgcolor'))
                       			$gan_plain_style .= 'background-color:' . Mage::helper('mec_navigation')->formatColor($category->getData('navigation_pw_s_bgcolor')) . ';';
                       		...
                       		if ($category->getData('navigation_pw_s_bsize') && $category->getData('navigation_pw_s_bcolor')){
                       			$gan_plain_style .= 'border:' . $category->getData('navigation_pw_s_bsize') . 'px solid ' . Mage::helper('mec_navigation')->formatColor($category->getData('navigation_pw_s_bcolor')) . ';';
                       		} 	
                       }  
                       ...
                       if ($this->_offer_block_html){
                       		switch ($category->getData('navigation_pw_ob_pos')){
                       			case Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::TOP :
                       					$html[] = $this->_offer_block_html;
                       				break;
                       			case Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::LEFT :
                       				...
                       				break;
                       			case Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::RIGHT :
                ...
                {        
                     ...
                     if ($this->_navigation_place == self::MENU_BAR && $category->getData('navigation_pw_s_img')){
                     	if ($category->getLevel() == ($this->_root_level + 1)){
                     		...
                     		if ($category_view != Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Attribute_View::TEXT){                      		
                     	...
                     	if ($navigation_image){
                     		$li_class .= Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::getListPositionClass($image_position);
                     	}                     	
                     }
                	 ...
                	 if ($navigation_image && in_array($image_position, array(Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::TOP, Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::LEFT))){
                     	$html[] = $navigation_image;
                     }

                     if (!($navigation_image && $category_view == Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Attribute_View::IMAGE)){                     
                     	$html[] = '<span>' . $this->escapeHtml($category->getName()) . '</span>';
                     }	
                     
                	 if ($navigation_image && in_array($image_position, array(Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::RIGHT, Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::BOTTOM))){
                     	$html[] = $navigation_image;
                     }
                ...
                {  
                    ...
                    if ($hasActiveChildren)
                    {
                       ...
                       if ($this->_offer_block_html && $category->getData('navigation_pw_ob_pos') != Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::TOP){
                       		$html[] = $this->_offer_block_html;
                       }                    
                       $html[] = '</div>'; //gan-plain
                    }   
            ...
            case Mec_Navigation_Model_Layer::FILTER_TYPE_FOLDING:
            ...
            case Mec_Navigation_Model_Layer::FILTER_TYPE_DEFAULT_PRO:    
                if ($hasActiveChildren && !$noEventAttributes) {
                         $attributes['onmouseover'] = 'toggleMenu(this,1)';
                         $attributes['onmouseout'] = 'toggleMenu(this,0)';
                    }
                    ...
                    $html[] = '</li>';
                 break;  
            case Mec_Navigation_Model_Layer::FILTER_TYPE_ACCORDION:            	
	        		$linkClass = '';
	                if ($isOutermost && $outermostItemClass) {
	                    $linkClass = $outermostItemClass;
	                }
    ...
    public function renderCategoriesMenuHtml($level = 0, $outermostItemClass = '', $childrenWrapClass = '')
    {
        ...
        foreach ($this->getStoreCategories($_root_category) as $child) {
            if ($child->getIsActive()) {                
                switch ($this->_navigation_place){
                    case self::LEFT_COLUMN :
                        if (Mage::getStoreConfig('mec_navigation/category/hide_empty') && 
                            !$child->getProductCount()){	                	    
	                	    continue 2;	                	    
	                	} 
                    break;
                    case self::RIGTH_COLUMN :
                        if (Mage::getStoreConfig('mec_navigation/rightcolumnsettings/hide_empty') && 
                            !$child->getProductCount()){	                	    
	                	    continue 2;	                	    
	                	} 
                    break;                                
    ...
    public function renderPlainImage($navigation_image, $category, $first_level){
		...
		if ($navigation_image)
		{
		     ...
		     $plain_image .= '<img class="' . Mec_Navigation_Model_Adminhtml_System_Config_Source_Category_Image_Position::getPositionClass($image_position) . '" ' . $_add_image_style . ' src="' . $navigation_image . '" alt="' . $this->escapeHtml($category->getName()) . '" />';		     				     		
		}
