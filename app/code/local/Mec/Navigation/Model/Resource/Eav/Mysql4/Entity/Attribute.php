<?php
	...
	class Mec_Navigation_Model_Resource_Eav_Mysql4_Entity_Attribute extends Mage_Catalog_Model_Resource_Eav_Mysql4_Attribute{
	                ...
	                foreach ($option['value'] as $optionId => $values) {
	                    ...
	                    if(isset($option['image'][$optionId])){
	                    	...
	                    	if(!empty($imageInfo) && isset($imageInfo['status']) && $imageInfo['status'] == 'new'){
	                    		...
	                    		$image 	= Mage::getSingleton('mec_navigation/observer')->moveImageFromTmp($imageInfo['file']);
								$name	= $imageInfo['name'];
