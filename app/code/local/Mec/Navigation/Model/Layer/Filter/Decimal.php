...
class Mec_Navigation_Model_Layer_Filter_Decimal extends Mec_Navigation_Model_Layer_Filter_Abstract
{	
        ...
        if ($data === null) {
            ...
            foreach ($dbRanges as $index=>$count) {
            	...
            	if(in_array($value, $selected) && $filter_mode){
					...
					if(!empty($selected) && $this->getAttributeModel()->getFilterType() != Mec_Navigation_Model_Layer::FILTER_TYPE_DROPDOWN ){
