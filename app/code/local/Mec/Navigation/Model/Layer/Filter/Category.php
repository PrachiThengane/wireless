...
class Mec_Navigation_Model_Layer_Filter_Category extends Mec_Navigation_Model_Layer_Filter_Abstract
{
    /**
     * Active Category Id
     *
    ...
    protected function _getItemsData()
    {
        ...
        if ($data === null) {
            ...
            if (Mage::getStoreConfigFlag('mec_navigation/category/show_allsubcats')){
            ...
            $filter_mode = Mage::helper('mec_navigation')->isMecNavigation();
        	...
        	if(count($this->category_list) > 0){
	            ...
	            foreach ($this->category_list as $category) {
	                ...
	                if ($category->getIsActive()) {
	                	...
	                	if (Mage::getStoreConfig('mec_navigation/category/hide_empty') && !isset($category_count[$category->getId()])){	                	    
	                	    continue;	                	    
	                	} 
