...
class Mec_Navigation_Model_Layer_Filter_Attribute extends Mec_Navigation_Model_Layer_Filter_Abstract
{
            ...
            foreach ($options as $option) {
                ...
                if (Mage::helper('core/string')->strlen($option['value'])) {
                	...
                	if(in_array($option['value'], $selected) && $filter_mode){
	                	...
	                	if(!empty($selected) && $attribute->getFilterType() != Mec_Navigation_Model_Layer::FILTER_TYPE_DROPDOWN){
