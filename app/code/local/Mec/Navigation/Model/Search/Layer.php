<?php
	...
	class Mec_Navigation_Model_Search_Layer extends Mec_Navigation_Model_Layer{
	    ...
	    protected function _prepareAttributeCollection($collection)
	    {
	        ...
	        $tableAlias = 'mec_nav_attr';
	        
	        $collection->getSelect()->joinLeft(
	            array($tableAlias => Mage::getSingleton('core/resource')->getTableName('mec_navigation_attribute')),
	        ...
	        $tableAliasStore = 'mec_nav_attr_store';
	        
	        $collection->getSelect()->joinLeft(
	        	array($tableAliasStore => Mage::getSingleton('core/resource')->getTableName('mec_navigation_attribute_store')),
