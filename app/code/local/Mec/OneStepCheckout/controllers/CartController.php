...
class Mec_OneStepCheckout_CartController extends Mage_Checkout_CartController
{
    /**
	...
	//New Add Function
	public function addCheckoutProductListAction()
	{
		$accessories_id = $this->getRequest()->getParam('accessories_id');
		$accessories_id  = implode(',', $accessories_id);
        
		Mage::log($accessories_id);
		$cart = Mage::getSingleton('checkout/cart');
		$cart->addProductsByIds(explode(',', $accessories_id));
		$cart->save();
