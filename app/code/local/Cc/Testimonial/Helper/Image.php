...
class Cc_Testimonial_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    public function __toString()
    {
    	try {
            ...
            if(!strlen(Mage::getStoreConfig('cc_testimonial/general/background'))){
    ...
    {
    	/*$color = explode(',',Mage::getStoreConfig('cc_tetimonial/general/background'));
    	if(sizeof($color)==3)
    	{
