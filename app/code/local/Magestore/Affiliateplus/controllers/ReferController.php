...
class Magestore_Affiliateplus_ReferController extends Mage_Core_Controller_Front_Action {
    ...
    public function emailAction() {
        ...
        if ($data = $this->getRequest()->getPost()) {
            $emails = $data['emails'];
            $data['email_subject'] = $data['email_subject'] ? $data['email_subject'] : Mage::getBlockSingleton('affiliateplus/refer')->getDefaultEmailSubject();
            $data['email_content'] = $data['email_content'] ? $data['email_content'] : Mage::getBlockSingleton('affiliateplus/refer')->getDefaultEmailContent();
            $session = $this->_getCoreSession();
    ...
    public function facebookAction() {
        ...
        try {
            ...
            if (!$message)
                $message = Mage::getBlockSingleton('affiliateplus/refer')->getDefaultSharingContent();
    ...
    function refineCustumUrlAction() {
