...
class AW_AdvancedReviews_Block_Product_Helper extends Mage_Review_Block_Helper{
    ...
    public function getReviewsUrl()
    {
        ...
        if(Mage::getStoreConfigFlag('web/seo/use_rewrites') && $shortLink = Mage::helper('advancedreviews')->getFuRewiewsUrl($this->getProduct()->getId(),$this->getProduct()->getCategoryId())){
            return $shortLink;
        }
        else{
