...
class AW_Onsale_Block_Product_Label extends Mage_Catalog_Block_Product_Abstract
{
	...
	public function setProduct($product)
	{
		...
		if ( $this->isShow() )
		{
			if ( $this->_custom )
			{
				$imageFile = 'uploaded'.DS.Mage::helper('onsale')->confGetCustomValue( $this->_placeRoute, $this->_type, 'image', $product );
    ...
    public function convertPosition($position){
        if(in_array($position, array('ML', 'MC', 'MR'))){
            ...
            if(in_array($position, array('BL', 'BC', 'BR'))){
                $vertical = 'bottom';
            }else{
                $vertical = 'top';
            }
        ...
        if(in_array($position, array('BL', 'TL', 'ML'))){
            ...
            if(in_array($position, array('BR', 'TR', 'MR'))){
                $hor = 'right';
            }else{
                $hor = 'center';
            }
