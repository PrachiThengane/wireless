    ...
    public function subscribeAction() {
        ...
        try {
            ...
            $summary
                    ...
                    ->setPointsExpirationNotification($isSubsc)
                    ->setUpdateDate(true)
                    ->save();
        } catch (Exception $e) {
        ...
        if ($isSubsc) {
            Mage::getSingleton('customer/session')->addSuccess(Mage::helper('points')->__('The subscription has been saved'));
        } else {
            Mage::getSingleton('customer/session')->addSuccess(Mage::helper('points')->__('The subscription has been removed'));
        }
