 ...
 */                $testCoupon = Mage::getModel('points/coupon')->loadByCouponCode($data['coupon_code']);
                ...
                if (strtotime($coupon->getData('from_date')) > strtotime($coupon->getData('to_date'))) {
                    $tmp = $coupon->getData('to_date');
                    $coupon->setData('to_date', $coupon->getData('from_date'));
                    $coupon->setData('from_date', $tmp);
                    unset($tmp);
                }
                $coupon->save();
