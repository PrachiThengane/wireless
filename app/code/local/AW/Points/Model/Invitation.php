 ...
 */class AW_Points_Model_Invitation extends Mage_Core_Model_Abstract {
    ...
    /**
     *
     * Saves invitation data in DB and returns instance
     *
     * @return AW_Points_Model_Invitation
     */
    public function getSavedInvitation($sessionData) {
        $this->loadByEmailAndStore($sessionData->getEmail(), $sessionData->getStoreId());
        ...
        if ($this->getStatus() != self::INVITATION_NEW) {
            Mage::throwException(self::INVITEE_EXIST);
        }
