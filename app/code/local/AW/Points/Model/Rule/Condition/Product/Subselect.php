 ...
 */
class AW_Points_Model_Rule_Condition_Product_Subselect
    extends AW_Points_Model_Rule_Condition_Product_Combine
{
    ...
    public function asHtml()
    {
        $html = $this->getTypeElement()->getHtml().
              Mage::helper('points')->__("If %s %s %s for a subselection of items in cart matching %s of these conditions:",
