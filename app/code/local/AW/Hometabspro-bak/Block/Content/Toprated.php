 ...
 */?>
<?php 
class AW_Hometabspro_Block_Content_Toprated extends AW_Hometabspro_Block_Content
{		
	protected function _prepareCollection()
	{
            $collection = parent::_prepareCollection();
            /* Top rated block tables */
            $reviewSummary = $this->getTableName('review/review_aggregate');
            $where =  Mage::getSingleton('core/session')->getHometabsProTopRated();
