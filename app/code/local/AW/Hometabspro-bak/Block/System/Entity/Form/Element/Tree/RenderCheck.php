...
class AW_Hometabspro_Block_System_Entity_Form_Element_Tree_RenderCheck extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Categories
{
    ...
    {
        parent::__construct();
        $this->setTemplate('aw_hometabspro/form/element/render/newTree.phtml');
    }
