...
class VisualFrames_Bestsellers_Block_Product_Bestsellers extends Mage_Catalog_Block_Product_Abstract
{
    public function __construct()
    {
		...
		$productSize = 4; //  No Of Products Display in Frontend 
		
		
		$storeId    = Mage::app()->getStore()->getId();
		$sql = "SELECT f.product_id, f.qty_ordered  FROM sales_flat_order_item as f, sales_flat_order_grid as s WHERE s.entity_id = f.order_id and s.store_id = $storeId and f.parent_item_id is NULL";
