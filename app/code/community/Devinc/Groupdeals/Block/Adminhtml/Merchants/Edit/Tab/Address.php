...
class Devinc_Groupdeals_Block_Adminhtml_Merchants_Edit_Tab_Address extends Mage_Adminhtml_Block_Widget_Form
{
  ...
  protected function _prepareForm()
  {
	  ...
	  $redeem = Mage::getModel('groupdeals/groupdeals')->getDecodeString(Mage::registry('groupdeals_data')->getRedeem(), $storeId);
	  Mage::registry('groupdeals_data')->setRedeem($redeem);
	  ...
	  $field = $fieldset->addField('redeem', 'text', array(
            ...
            'note'      => 'The redeem message will appear in case no address is present',
			'style'     => 'width:594px;',
            'required'  => true,
      ));	
