...
class Devinc_Groupdeals_Block_Adminhtml_Groupdeals_Edit_Renderer_Dealover extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    {	
		...
		$notification = Mage::getModel('groupdeals/notifications')->getCollection()->addFieldToFilter('type', 'deal_over')->addFieldToFilter('groupdeals_id', $this->getRequest()->getParam('groupdeals_id'))->addFieldToFilter('website_id', $website_id)->setOrder('notification_id', 'DESC')->getFirstItem();
		if ($notification) {
