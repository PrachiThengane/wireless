...
class Devinc_Groupdeals_Block_Adminhtml_Groupdeals_Edit_Renderer_Fineprint extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{

    public function render(Varien_Data_Form_Element_Abstract $element) 
	{		      	
		$productId  = (int) $this->getRequest()->getParam('id');
		$default = Mage::getModel('catalog/product')->setStoreId(0)->load($productId)->getGroupdealFineprint();
