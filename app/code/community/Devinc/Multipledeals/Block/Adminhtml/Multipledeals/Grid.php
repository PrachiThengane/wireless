...
class Devinc_Multipledeals_Block_Adminhtml_Multipledeals_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  public function getRowNumber($id)
  {
	...
	$collection_size = Mage::getModel('catalog/product')->getCollection()->setOrder('entity_id', 'DESC')->addAttributeToFilter('visibility', $visibility)->addAttributeToFilter('entity_id', array('gteq' => $id))->getSize();
