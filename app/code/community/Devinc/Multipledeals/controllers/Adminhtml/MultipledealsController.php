		...
		if ($data = $this->getRequest()->getPost()) {
			...
			try {				
				...
				if ($this->getRequest()->getParam('back')) {
					...
					$collection_size = Mage::getModel('catalog/product')->getCollection()->setOrder('entity_id', 'DESC')->addAttributeToFilter('visibility', $visibility)->addAttributeToFilter('entity_id', array('gteq' => $selected_product_id))->getSize();
					
					$page_nr = $collection_size;
